    ...
    public String createEvent(String name, String day, String month, String year){
        try{
            if(name.length() == 0){
                ...
                Event event = new Event(0, name, LocalDate.of(Integer.parseInt(year), Integer.parseInt(month), Integer.parseInt(day)));
                dae.create(event);
     ...
     public String updateEvent(String name, String day, String month, String year){
        try{
            if(name.length() == 0){
                return ("Please input a name");
            }  
